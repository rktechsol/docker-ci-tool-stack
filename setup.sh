...
#
# curl -sSL https://raw.githubusercontent.com/rktechsol/docker-ci-tool-stack/master/setup.sh | bash -s
#
# Prerequisites:
...
git clone git@github.com:rktechsol/docker-ci-tool-stack.git
